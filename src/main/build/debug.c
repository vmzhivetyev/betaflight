...
const char * const debugModeNames[DEBUG_COUNT] = {
    ...
    [DEBUG_DSHOT_STATUS_ERPM18] = "DSHOT_STATUS_ERPM18",
    [DEBUG_DSHOT_STATUS_TEMP] = "DSHOT_STATUS_TEMP",
    [DEBUG_DSHOT_STATUS_VOLT] = "DSHOT_STATUS_VOLT",
    [DEBUG_DSHOT_STATUS_AMP] = "DSHOT_STATUS_AMP",
    [DEBUG_DSHOT_STATUS_DEBUG1] = "DSHOT_STATUS_DEBUG1",
    [DEBUG_DSHOT_STATUS_DEBUG2] = "DSHOT_STATUS_DEBUG2",
    [DEBUG_DSHOT_STATUS_STRESS] = "DSHOT_STATUS_STRESS",
    [DEBUG_DSHOT_STATUS] = "DSHOT_STATUS",
    [DEBUG_VARIO] = "DEBUG_VARIO",
};
