...
// PG_MOTOR_CONFIG
    ...
    { PARAM_NAME_MOTOR_PWM_RATE,    VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 10, 32000 }, PG_MOTOR_CONFIG, offsetof(motorConfig_t, dev.motorPwmRate) },
...
// PG_BATTERY_CONFIG
    { "liion_bat_mode",             VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_BATTERY_CONFIG, offsetof(batteryConfig_t, isLiionModeActive) },
    ...
    { "vbat_min_cell_voltage_liion",VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { VBAT_CELL_VOTAGE_RANGE_MIN, VBAT_CELL_VOTAGE_RANGE_MAX }, PG_BATTERY_CONFIG, offsetof(batteryConfig_t, vbatmincellvoltageLiion) },
    ...
    { "vbat_warning_cell_voltage_liion",VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { VBAT_CELL_VOTAGE_RANGE_MIN, VBAT_CELL_VOTAGE_RANGE_MAX }, PG_BATTERY_CONFIG, offsetof(batteryConfig_t, vbatwarningcellvoltageLiion) },
    ...
    { "current_meter_adc_hz",       VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 1, 8000 }, PG_BATTERY_CONFIG, offsetof(batteryConfig_t, currentMeterADCHz) },
...
// PG_GPS_CONFIG
    ...
    { PARAM_NAME_GPS_RESCUE_SANITY_CHECKS,   VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GPS_RESCUE_SANITY_CHECK }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, sanityChecksMode) },
...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_DYN_IDLE_PER_MOTOR,         VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, dyn_idle_per_motor) },
#endif
...
// PG_OSD_CONFIG
    ...
    { "osd_esc_stress_alarm",       VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0, DSHOT_TELEMETRY_STATUS_MAX_STRESS_LVL_VALUE }, PG_OSD_CONFIG, offsetof(osdConfig_t, esc_stress_alarm) },
    { "osd_pid_slow_alarm",         VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 50 }, PG_OSD_CONFIG, offsetof(osdConfig_t, osd_pid_slow_alarm) },
    ...
    { "osd_pid_roll_qual_pos",      VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_ROLL_PID_QUALITY]) },
    { "osd_pid_pitch_qual_pos",     VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_PITCH_PID_QUALITY]) },
    ...
    { "osd_esc_stress_pos",         VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_ESC_STRESS]) },
...
#ifdef USE_OSD_PROFILES
    { "osd_profile",                VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, OSD_PROFILE_COUNT }, PG_OSD_CONFIG, offsetof(osdConfig_t, osdProfileNumber) },
...
// PG_TIMECONFIG
    ...
    { PARAM_NAME_RPM_FILTER_Q,             VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 10, 3000 }, PG_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_filter_q) },
...
// PG_AUTOPILOT
...
#ifdef USE_WING
    { PARAM_NAME_AP_THROTTLE,            VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 1100, 1900 }, PG_AUTOPILOT, offsetof(autopilotConfig_t, ap_throttle) },
    { PARAM_NAME_AP_THROTTLE_MIN,        VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 1050, 1800 }, PG_AUTOPILOT, offsetof(autopilotConfig_t, ap_throttle_min) },
    { PARAM_NAME_AP_THROTTLE_MAX,        VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 1200, 2000 }, PG_AUTOPILOT, offsetof(autopilotConfig_t, ap_throttle_max) },
    ...
    { PARAM_NAME_AP_ALTITUDE_D_LPF_HZ,   VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 200 },     PG_AUTOPILOT, offsetof(autopilotConfig_t, ap_altitude_d_lpf_hz) },
    { PARAM_NAME_AP_COG_P,               VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 200 },     PG_AUTOPILOT, offsetof(autopilotConfig_t, ap_cog_P) },
    { PARAM_NAME_AP_COG_I,               VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 200 },     PG_AUTOPILOT, offsetof(autopilotConfig_t, ap_cog_I) },
    { PARAM_NAME_AP_COG_D,               VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 200 },     PG_AUTOPILOT, offsetof(autopilotConfig_t, ap_cog_D) },
    { PARAM_NAME_AP_MAX_ROLL,            VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 10, 70 },     PG_AUTOPILOT, offsetof(autopilotConfig_t, ap_max_roll) },
    { PARAM_NAME_AP_MAX_PITCH,           VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 10, 70 },     PG_AUTOPILOT, offsetof(autopilotConfig_t, ap_max_pitch) },
#else // USE_WING
